...
|**Web Technologies**|XML, CSS, HTML, DHTML, JavaScript, JQuery, MVC3, Bootstrap, RESTful, AJAX, Java Script, JQuery and Node.js.|
|**Web Services**|SOAP, REST|
|**Tools & IDE**|Eclipse, PyDev, Django PyCharm, PyScripter, Spyder, PyStudio|
